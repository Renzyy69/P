...
wget -q https://raw.githubusercontent.com/Renzyy69/P/main/menu/menu.zip -O menu.zip
unzip menu.zip
chmod +x menu/*
...
wget -q https://raw.githubusercontent.com/Renzyy69/P/main/versionbaru -O /usr/local/sbin/version
