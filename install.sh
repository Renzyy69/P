...
repo="https://raw.githubusercontent.com/Renzyy69/P/main/"
...
WantedBy=multi-user.target
EOF
wget https://raw.githubusercontent.com/Renzyy69/vip/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
clear
wget -q -O /usr/bin/limit-ip "https://raw.githubusercontent.com/Renzyy69/P/main/limit/limit-ip"
chmod +x /usr/bin/*
cd /usr/bin
sed -i 's/\r//' limit-ip
cd
